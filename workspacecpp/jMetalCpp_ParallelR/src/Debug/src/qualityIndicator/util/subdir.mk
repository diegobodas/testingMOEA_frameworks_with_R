...
CPP_SRCS += \
../src/qualityIndicator/util/LexicoGraphicalComparator.cpp \
../src/qualityIndicator/util/MetricsUtil.cpp 

OBJS += \
./src/qualityIndicator/util/LexicoGraphicalComparator.o \
./src/qualityIndicator/util/MetricsUtil.o 

CPP_DEPS += \
./src/qualityIndicator/util/LexicoGraphicalComparator.d \
./src/qualityIndicator/util/MetricsUtil.d 


# Each subdirectory must supply rules for building sources it contributes
src/qualityIndicator/util/%.o: ../src/qualityIndicator/util/%.cpp
	@echo 'Building file: $<'
