...
SolutionSet * NSGAII::execute() {
  ...
  cout << "Comienza la inicializacion de la poblacion con tama�o " << populationSize << endl;
...
//    cout << "Solution a�adida a la poblacion" << endl;
  } //for
...
//    cout << "NSGAII: Ejecutada uni�n..." << endl;

    // Ranking the union
    Ranking * ranking = new Ranking(unionSolution);

//    cout << "NSGAII: Inicializado ranking con tama�o = " << ranking->getNumberOfSubfronts() << endl;
...
//    cout << "NSGAII: Obtenido frente de pareto con tama�o " << front->size() << endl;
...
//        cout << "NSGAII: A�adido frente(" << k << ") a la poblacion con tama�o " << population->size() << endl;
      } // for
